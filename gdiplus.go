...
var (
	...
	gdipCreateBitmapFromStream  uintptr
	gdipLoadImageFromStream     uintptr
	gdipGetImageWidth           uintptr
	gdipGetImageHeight          uintptr
	gdipDrawImageRectI          uintptr
)
...
func init() {
	...
	gdipCreateBitmapFromStream = MustGetProcAddress(libgdiplus, "GdipCreateBitmapFromStream")
	gdipLoadImageFromStream = MustGetProcAddress(libgdiplus, "GdipLoadImageFromStream")
	gdipGetImageWidth = MustGetProcAddress(libgdiplus, "GdipGetImageWidth")
	gdipGetImageHeight = MustGetProcAddress(libgdiplus, "GdipGetImageHeight")
	gdipDrawImageRectI = MustGetProcAddress(libgdiplus, "GdipDrawImageRectI")
...
func GdipCreateBitmapFromStream(stream uintptr, bitmap **GpBitmap) GpStatus {
	ret, _, _ := syscall.Syscall(gdipCreateBitmapFromStream, 2,
		stream,
		uintptr(unsafe.Pointer(bitmap)),
		0)
...
func GdipLoadImageFromStream(stream uintptr, image **GpImage) GpStatus {
	ret, _, _ := syscall.Syscall(gdipLoadImageFromStream, 2,
		stream,
		uintptr(unsafe.Pointer(image)),
		0)
...
func GdipGetImageWidth(image *GpImage, width *uint32) GpStatus {
	ret, _, _ := syscall.Syscall(gdipGetImageWidth, 2,
		uintptr(unsafe.Pointer(image)),
...
func GdipGetImageHeight(image *GpImage, height *uint32) GpStatus {
	ret, _, _ := syscall.Syscall(gdipGetImageHeight, 2,
		uintptr(unsafe.Pointer(image)),
...
func GdipDrawImageRectI(hdc HDC, image *GpImage, x, y, width, height int32) GpStatus {
	ret, _, _ := syscall.Syscall6(gdipDrawImageRectI, 6,
		uintptr(hdc),
		uintptr(unsafe.Pointer(image)),
		uintptr(x),
		uintptr(y),
